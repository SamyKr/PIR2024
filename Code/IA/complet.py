...
if  testmode :
    train_indices = repartition_data["train"][:20]
    test_indices = repartition_data["test"][:20]
    validation_indices = repartition_data["validation"][:20]
else :
...
if __name__ == "__main__":
    ...
    parser.add_argument("--loss_function", type=str, default="BCEWithLogitsLoss", choices=["CrossEntropyLoss", "BCEWithLogitsLoss", "MSELoss"], help="Loss function to use")
